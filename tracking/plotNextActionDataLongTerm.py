...
#	plt.fill_between(x,yweek,[0] *len(seconds),color='red')
	...
	lastweek=myround(currenttime-180*24*3600)
	...
	plt.grid()
	plt.savefig('/home/joereddington/joereddington.com/stress/stressLongTerm.png')

a=processFile("/home/joereddington/Jurgen/tracking/resultsCompressed.txt")
